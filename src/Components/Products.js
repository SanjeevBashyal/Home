...
const Products = (props) => {
    ...
    // const size=useRef(size_original);
    const sz=size_original;
    // const [sz,setSz]=useState(size_original);
    const id1=props.id1;
    const id2=props.id2;
    const [colourList,setColourList]=useState([0,30,60,90,120,150,180,210,240,270,300,330,360]);
    // const interval_grow=useRef(null);
    const interval_colour=useRef(null);
