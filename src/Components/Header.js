...
const Header = () => {
    ...
    const runThis=()=>{
        change(i%361)
        i=i-5;
        setTimeout(function(){runThis()},90)
    }
    ...
    return ( 
        <div className="header">
            <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="384.765" height="402.9451" viewBox="0 0 384.765 402.9451">
            <defs>
            ...
            <linearGradient id="hue3" x1="0" y1="0" x2="1" y2="1">
                ...
                <path class="cls-2" d="M464,284.5726V465.7H646.6" 
                    transform="translate(-343 -181)" fill="none" stroke="url(#hue)" strokeWidth="2px"/>
                <path class="cls-2"
                    ...
                    transform="translate(-343 -181)" fill="none" stroke="url(#hue2)" strokeWidth="2px"/>
